...
<div class="mt-5">
    <div class="px-6">
        <div class="p-4">
            <h4 class="font-poppins text-2xl font-semibold text-gray-600">Edit Post - {{ $article->slug }}</h4>
        </div>
        <div class="card-body p-4">
            {{-- Start the form --}}
            <x-forms::form :model="$article" :action="route('articles.update', $article->slug)" method="PATCH" enctype="multipart/form-data">
